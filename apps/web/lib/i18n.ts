...
const dictionaries = {
  en: {
    ...
    bankAccounts: {
      ...
      importDone: (n: number) => `${n} transaction${n === 1 ? "" : "s"} imported`,
      importFailed: "Sync failed",
      // Connect modal
      selectBank: "Select a bank",
      credentialsTitle: (bank: string) => `Connect ${bank}`,
  ...
  he: {
    ...
    bankAccounts: {
      ...
      importDone: (n: number) => `יובאו ${n} עסקאות`,
      importFailed: "הסנכרון נכשל",
      // Connect modal
      selectBank: "בחר בנק",
      credentialsTitle: (bank: string) => `חבר ${bank}`,
