...
const dictionaries = {
  en: {
    ...
    budgets: {
      ...
      totalActual: "Spent",
      remaining: "Remaining",
      dashboardTitle: "Budget vs Actual",
    ...
    settings: {
      ...
      whatsapp: {
        ...
        maxHistoryHint: "Number of messages to remember (1–200)",
        clearHistory: "Clear Chat History",
        clearHistoryConfirm: "Delete all conversation history? The bot will forget previous messages.",
  ...
  he: {
    ...
    bankAccounts: {
      ...
      inLabel: "בעוד",
      overdue: "באיחור",
      enable: "סנכרון אוטו. כבוי",
      disable: "סנכרון אוטו. פעיל",
    ...
    budgets: {
      navLabel: "תקציב",
      title: "תקציב חודשי",
      subtitle: "קבע מגבלות הוצאות לכל קטגוריה ועקוב אחר ההתקדמות.",
      category: "קטגוריה",
      avg3m: "ממוצע 3 ח׳",
      avg6m: "ממוצע 6 ח׳",
      monthlyBudget: "תקציב",
      ...
      totalActual: "הוצא",
      remaining: "נותר",
      dashboardTitle: "תקציב מול בפועל",
      noData: "אין קטגוריות עדיין",
      forecastedIncome: "הכנסה צפויה",
    ...
    settings: {
      ...
      whatsapp: {
        ...
        maxHistory: "מקסימום היסטוריית שיחה",
        maxHistoryHint: "מספר הודעות לזכור (1–200)",
        clearHistory: "נקה היסטוריית שיחה",
        clearHistoryConfirm: "למחוק את כל היסטוריית השיחה? הבוט ישכח הודעות קודמות.",
        clearingHistory: "מנקה…",
