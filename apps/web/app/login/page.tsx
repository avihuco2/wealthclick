...
export default async function LoginPage() {
  ...
  return (
    <div className="min-h-full flex flex-col items-center justify-center px-4">
      {/* Background gradient — subtle, Apple-like */}
      <div
        aria-hidden
        className="pointer-events-none fixed inset-0 -z-10 overflow-hidden"
      >
        <div className="absolute -top-40 left-1/2 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-primary/8 blur-[120px]" />
        <div className="absolute bottom-0 left-0 h-[400px] w-[400px] rounded-full bg-blue-200/20 blur-[100px]" />
      </div>
      ...
      <div className="w-full max-w-sm">
        ...
        {/* Login card */}
        <div className="rounded-2xl bg-card px-8 py-8 shadow-sm ring-1 ring-border">
          <h2 className="mb-1 text-center text-[17px] font-semibold text-foreground">
            Sign in to continue
          </h2>
          ...
          >
            <button
              type="submit"
              className="group flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-card px-4 py-3 text-[15px] font-medium text-foreground shadow-sm transition-all duration-200 hover:bg-muted hover:shadow-md active:scale-[0.98]"
            >
              <GoogleIcon />
